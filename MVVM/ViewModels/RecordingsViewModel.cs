...
{
    internal class RecordingsViewModel : ObservableObject
    {
        private readonly IG3Api _g3;
        private bool _scanning;
        private RecordingViewModel _selectedRecording;
        public ObservableCollection<RecordingViewModel> Recordings { get; } = new ObservableCollection<RecordingViewModel>();

        public RecordingViewModel SelectedRecording
        {
        ...
        public RecordingsViewModel(Dispatcher dispatcher, IG3Api g3) : base(dispatcher)
        {
            _g3 = g3;
        ...
        private async Task SyncRecordings()
        {
            ...
            foreach (var r in deviceRecordings)
            {
                ...
                {
                    var recordingVm = await RecordingViewModel.Create(Dispatcher, r, _g3);
                    Dispatcher.Invoke(() =>
                    {
                        var inserted = false;
