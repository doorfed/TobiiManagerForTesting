...
using Utils = TobiiGlassesManager.Core.Utils;
...
namespace TobiiGlassesManager.MVVM.ViewModels
{
    internal class CalibrationViewModel : ObservableObject
    {
        ...
        public CalibrationViewModel(IG3Api g3, Dispatcher dispatcher) : base(dispatcher)
        {
            _g3 = g3;
            ...
            _centerColor = _black;
            _middleColor = _white;
            ChangeScale = new RelayCommand(o => DoChangeSize(o));
            Calibrate = new RelayCommand(async o => await DoCalibrate());
        ...
        public RelayCommand ChangeScale { get; set; }
